...
public class CatalogServiceHostModule : AbpModule
{
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            c.AddConsumers(
            typeof(CatalogServiceApplicationModule).Assembly,
    ...
    private void ConfigureVirtualFileSystem(ServiceConfigurationContext context)
    {
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            ...
            {
                options.FileSets.ReplaceEmbeddedByPhysical<CatalogServiceDomainSharedModule>(
                    Path.Combine(
                        hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}CatalogService.Domain.Shared"
                    )
                );
                options.FileSets.ReplaceEmbeddedByPhysical<CatalogServiceDomainModule>(
                    Path.Combine(
                        hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}CatalogService.Domain"
                    )
                );
                options.FileSets.ReplaceEmbeddedByPhysical<CatalogServiceApplicationContractsModule>(
                    Path.Combine(
                        hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}CatalogService.Application.Contracts"
                    )
                );
                options.FileSets.ReplaceEmbeddedByPhysical<CatalogServiceApplicationModule>(
                    Path.Combine(
                        hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}CatalogService.Application"
                    )
                );
            });
        }
    ...
    private void ConfigureRedis(ServiceConfigurationContext context, IConfiguration configuration)
    {
        ...
        {
            options.KeyPrefix = "CatalogService:";
        });
